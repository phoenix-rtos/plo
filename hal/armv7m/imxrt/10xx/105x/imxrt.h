...
enum { clk_mux_pll3 = 0, clk_mux_periph, clk_mux_semcAlt, clk_mux_semc, clk_mux_prePeriph, clk_mux_trace,
    clk_mux_periphclk2, clk_mux_lpspi, clk_mux_flexspi, clk_mux_usdhc2 = 10, clk_mux_usdhc1,
	clk_mux_sai3, clk_mux_sai2, clk_mux_sai1, clk_mux_perclk, clk_mux_flexio2, clk_mux_can, clk_mux_uart,
	clk_mux_enc, clk_mux_ldbDi1, clk_mux_ldbDi0, clk_mux_spdif, clk_mux_flexio1, clk_mux_lpi2c, clk_mux_lcdif1pre,
	clk_mux_lcdif1, clk_mux_csi };


enum { clk_div_arm = 0, clk_div_periphclk2, clk_div_semc, clk_div_ahb, clk_div_ipg, clk_div_lpspi, clk_div_lcdif1,
    clk_div_flexspi, clk_div_perclk = 9, clk_div_ldbDi1, clk_div_ldbDi0, clk_div_can, clk_div_trace, clk_div_usdhc2,
...
enum {
    ...
    /* CCM_CCGR7 */
    pctl_clk_enet2, pctl_clk_axgr, pctl_clk_axbs_l, pctl_clk_can3, pctl_clk_can3_serial,
...
enum {
    ...
    pctl_gpr_flexio1_stop_req, pctl_gpr_flexio2_stop_req, pctl_gpr_flexio3_stop_req, pctl_gpr_edma_stop_ack = 127 + 16,
	pctl_gpr_can1_stop_ack, pctl_gpr_can2_stop_ack, pctl_gpr_trng_stop_ack, pctl_gpr_enet_stop_ack,
	pctl_gpr_sai1_stop_ack, pctl_gpr_sai2_stop_ack, pctl_gpr_sai3_stop_ack, pctl_gpr_enet2_stop_ack,
	pctl_gpr_semc_stop_ack, pctl_gpr_pit_stop_ack, pctl_gpr_flexspi_stop_ack, pctl_gpr_flexio1_stop_ack,
	pctl_gpr_flexio2_stop_ack, pctl_gpr_flexio3_stop_ack,
...
extern int _imxrt_getDevClock(int dev, unsigned int *state);
