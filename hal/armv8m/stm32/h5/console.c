...
void console_init(void)
{
	static const struct {
		...
		{ UART11_BASE, UART11_CLK, ipclk_usart11sel },
		{ UART12_BASE, UART12_CLK, ipclk_uart12sel },
	};
	...
	halconsole_common.refclkfreq = 32UL * 1000UL * 1000UL;
	...
	*(halconsole_common.base + brr) = halconsole_common.refclkfreq / 115200UL; /* 115200 baud rate */
	hal_cpuDataMemoryBarrier();
