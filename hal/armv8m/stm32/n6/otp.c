...
// /* Only for debug purposes for now */
...
// 			case -ERANGE:
// 				return "Error: Invalid fuse number";
// 			case -EAGAIN:
// 				return "Error: Try again";
// 			case -EPERM:
// 				return "Error: Fuse word already locked";
// 			case -EINVAL:
// 				return "Error: Lower fuse words have different lock states";
// 		}
// 	}
// 	else {
// 		return
