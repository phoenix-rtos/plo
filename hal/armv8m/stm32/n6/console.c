...
void console_init(void)
{
	...
	const int uart = UART_CONSOLE_PLO, port = UART_IO_PORT, txpin = UART_PIN_TX, rxpin = UART_PIN_RX, af = UART_IO_AF;
	...
	_stm32_rccSetIPR(uarts[uart].ipclk_sel, uart_clk_sel_hsi_div_ck);
