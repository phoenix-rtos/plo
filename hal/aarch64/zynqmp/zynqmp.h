...
enum ctl_clock_sys_pll_src {
	ctl_clock_sys_pll_src_video = 0,
	ctl_clock_sys_pll_src_alt,
	ctl_clock_sys_pll_src_aux,
	ctl_clock_sys_pll_src_gt,
	ctl_clock_sys_pll_src_ps,
};

enum ctl_clock_dev {
	ctl_clock_dev_rpll = 0,
	ctl_clock_dev_iopll,
	ctl_clock_dev_apll,
	ctl_clock_dev_dpll,
	ctl_clock_dev_vpll,
	ctl_clock_dev_rpll_to_fpd,
	ctl_clock_dev_iopll_to_fpd,
	ctl_clock_dev_apll_to_lpd,
	ctl_clock_dev_dpll_to_lpd,
	ctl_clock_dev_vpll_to_lpd,
	ctl_clock_dev_lpd_usb3_dual = 0x12,
...
extern void _zynqmp_startApuCore(int idx, addr_t resetVector);
