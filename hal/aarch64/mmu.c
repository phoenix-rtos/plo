...
#define MAIR_DEV_GRE              0x3 /* Gathering, re-ordering, early write acknowledge all enabled */
...
static u64 ttl1[4] __attribute__((section(".uncached_ddr"), aligned(64)));
static u64 ttl2[4][512] __attribute__((section(".uncached_ddr"), aligned(SIZE_PAGE)));
...
void mmu_init(void)
{
	...
	tcr |=
			...
			(0uL << 10) | /* Outer non-cacheable */
			(0uL << 8) |  /* Inner non-cacheable */
	...
	mair =
			...
			MAIR_ATTR(MAIR_IDX_DEVICE, MAIR_DEVICE(MAIR_DEV_nGnRnE));
