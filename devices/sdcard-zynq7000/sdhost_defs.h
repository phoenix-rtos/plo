...
typedef union {
	struct {
		u32 dmaEnable : 1;
		u32 blockCountEnable : 1;
		u32 autoCmd12Enable : 1;
		u32 reserved1 : 1;
		u32 directionRead : 1;
		u32 multiBlock : 1;
		u32 reserved2 : 10;
		u32 responseType : 2;
		u32 reserved3 : 1;
		u32 crcCheckEnable : 1;
		u32 indexCheckEnable : 1;
		u32 dataPresent : 1;
		u32 commandType : 2;
		u32 commandIdx : 6;
		u32 reserved4 : 2;
...
#define SWITCH_FUNC_REG_MAX_CURRENT(x)               (((u16)x[0] << 8) | x[1])
