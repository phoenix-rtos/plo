...
static const struct {
	...
	{ UART10_BASE, UART10_CLK, UART10_IRQ, dev_gpiod, 3, 6, dev_gpiob, 9, 6, ipclk_usart10sel },
#else
...
static u32 uart_configureRefclk(unsigned int minor)
{
	/* TODO: make this configurable, currently we run everything from HSI */
	_stm32_rccSetIPR(uartInfo[minor].ipclk_sel, uart_clk_sel_hsi_div_ck);
	return 64 * 1000 * 1000;
}
#endif
