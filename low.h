...
extern void low_initphfs(phfs_handler_t *handlers);

extern void low_initdevs(cmd_device_t **devs);

extern void low_appendcmds(cmd_t *cmds);


/* Setters and getters for common data */

extern void low_setDefaultIMAP(char *imap);

extern void low_setDefaultDMAP(char *dmap);

extern void low_setKernelEntry(u32 addr);

extern void low_setLaunchTimeout(u32 timeout);
